...
function initHomePage() {
  ...
  const recentPhotos = getPhotos().slice(-3).reverse();
  const recentContainer = document.getElementById("recent-photos");
  ...
  if (recentContainer) {
    ...
    recentContainer.querySelectorAll('[data-profile-link="true"]').forEach((link) => {
